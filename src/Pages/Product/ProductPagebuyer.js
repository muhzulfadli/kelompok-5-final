    ...
    <div className="grid grid-cols-5 gap-6">
      ...
      <div className="col-span-2">
        <div className="shadow-auto rounded-lg p-5">
          ...
          <div className={`bg-black bg-opacity-50 absolute top-0 left-0 inset-0 ${isOpen ? "flex":"hidden"} justify-center items-center`} id="overlay">
            <div className="bg-white rounded-2xl">
              <div className="flex justify-end items-center pr-4 pt-3">
                <button onClick={ () => setIsOpen(false)}><svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor" id="close-modal">
                <path fillRule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clipRule="evenodd" /></svg></button>
              </div>
              <div>
          ...
          <div className="flex shadow-auto rounded-2xl py-4 bg-[#fffcfc]"><input className="pl-3 focus:outline-none" required
          defaultValue="Rp 0,00" variant="filled"></input>           
          </div>
          </div> 
          </div>
