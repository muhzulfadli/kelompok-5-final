...
const NotificationCard = (closeClick) => {
  return (
    <div onClick={closeClick} className="absolute origin-top-right w-80 bg-white shadow-auto rounded-xl px-4 py-3 -ml-72 mt-8">
      <Link to="/notification">
        <div className="flex py-4 gap-4 cursor-pointer">
          <div>
            <img src="/images/picprofile.png" alt="" className="rounded-md cover" />
          </div>
